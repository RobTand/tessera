...
# The dump family this wrapper writes.  Overridable so a second campaign over
# the same two arms (compiled, #113) does not overwrite #102's eager dumps;
# the default is #102's own name and is byte-identical to what it wrote.
