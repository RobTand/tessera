# #93 — a dropped arm is now named, and the denominator is the grid

Branch `muse/ts-93-griddrop`, three commits on master `82cdf51`.
...
the grid and cannot be read as a comparison over it (#93)
EXIT=1
```
...
* **#97** — land #18's offline `pair_report.py` against `pair_grid_audit` or
  ...
  copies of a completeness rule is the shape of the bug #93 was.
