...
def test_the_packaged_contract_validates_at_v32(contract):
    ...
    v32 (tessera#555) changes what a field MEANS outside the lane table and
    ...
    the executing one.  NUMBERING NOTE: this v32 collides with open PR #560's
    v32; the second to land takes v33.
    """
